...
SAMPLE_SUB_PATH = "./../outputs/SampleSubmission.csv"
...
# Extract numerical and categorical cols
TARGET = "Target"
ID_COL = "ID"
...
ensemble = VotingClassifier(
    ...
    voting='hard' # Boost performance in this case (over 'soft')
)
...
# CV Macro F1: 0.9778 ± 0.0024 (ensemble with soft voting)
# CV Accuracy: 0.9944 ± 0.0004 (ensemble with soft voting)

# CV Macro F1: 0.9777 ± 0.0012 (ensemble with hard voting)
# CV Accuracy: 0.9947 ± 0.0004 (ensemble with hard voting)
...
save_path = "./../outputs/sub_et+rf+tabpfn.csv"
